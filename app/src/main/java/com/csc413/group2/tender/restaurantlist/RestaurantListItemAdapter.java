package com.csc413.group2.tender.restaurantlist;
 ...
 * MainActivity using the list_item layout in res/layout/.
 *
...
public class RestaurantListItemAdapter extends ArrayAdapter<Restaurant> {
    private final String TAG = "RestaurantListItemAdapter";
     ...
     */
    public RestaurantListItemAdapter(Context context, Restaurant[] restaurants) {
