...
import com.csc413.group2.tender.gson.GSONParser;
...
public class YelpRequestService extends IntentService {
    ...
    protected void onHandleIntent(Intent workIntent) {
        ...
        HashMap<String, String> hash = (HashMap<String, String>) workIntent.getSerializableExtra(
                MainActivity.SEARCH_PARAMETER_HASH);

        // Store the search parameters from the hashmap in strings.
        String location = hash.get(MainActivity.HASH_KEY_SEARCH_LOCATION);
        String term = hash.get(MainActivity.HASH_KEY_SEARCH_TERM);
        String limit = hash.get(MainActivity.HASH_KEY_SEARCH_LIMIT);
        ...
        /*
         * Broadcast the results to MainActivity using the local broadcast manager.
