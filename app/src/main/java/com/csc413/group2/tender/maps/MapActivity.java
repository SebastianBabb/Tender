package com.csc413.group2.tender.maps;
...
public class MapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    // Intent keys for retrieving the restaurant object.
    ...
    public void onMapReady(GoogleMap googleMap) {
        // Retrieve the intent from MainActivity.
        Intent mapIntent = getIntent();


        /*
         * DONT REMOVE. MAY COME IN HANDY IF WE WANT TO DISPLAY A BUNCH OF RESTAURNTS ON A SINGLE MAP.
         ...
         */
//        Object[] temp = (Object[]) mapIntent.getSerializableExtra(RESTAURANT_KEY);
...
//        temp = null;
        ...
        // Retrieve the restaurant object from the intent.
        mRestaurant = (Restaurant)mapIntent.getSerializableExtra(RESTAURANT_KEY);
        // String together the address for converting to lat/long.
        /*
         * Elaine, you can bypass this step (and the call to the GeocodeService.class below, and
         * just pass the lat/log from the restaurant object to the map fragment object in the
         * displayLocation() method.
         */
        address = mRestaurant.getLocation().getAddress()[0] + ", " +
    ...
    private void displayLocation() {
        ...
        if (mMapFragment.getMap() != null) {
            ...
            mMapFragment.getMap().addMarker(new MarkerOptions().title(mRestaurant.getName()).position(restaurantLatLong));
        }
    }
